      ...
      <div className="fixed left-0 top-0 w-56 h-screen bg-gradient-to-b from-teal-900 via-teal-800 to-teal-900 text-white shadow-2xl flex flex-col">
        ...
        <div className="p-6 border-b border-teal-700">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              <p className="font-serif text-lg font-bold">Flavors & Events</p>
        ...
        <div className="p-4 border-t border-teal-700">
          <div className="flex items-center gap-3 cursor-pointer group">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold truncate">Enam Egyir</p>
              <p className="text-xs text-teal-200 truncate">Business Owner</p>
            </div>
            <button className="text-teal-200 hover:text-white">⋮</button>
          </div>
        </div>
      </div>
      ...
      <div className="ml-56 min-h-screen">
        ...
        <div className="bg-white border-b border-slate-200 sticky top-0 z-30">
          <div className="px-8 py-4 flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Good morning, Enam! 👋</h1>
              <p className="text-slate-600 text-sm mt-1">Here's what's happening with your catering business today.</p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-6 mb-8">
            ...
            <div className="col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
              <div className="flex items-center justify-between mb-6">
                ...
                <select className="text-sm text-slate-600 border border-slate-200 rounded-lg px-3 py-1.5">
